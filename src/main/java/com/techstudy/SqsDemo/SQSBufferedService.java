...
@Service
public class SQSBufferedService {

    public SQSBufferedService() {
        SQSConfig.init();
    }
    ...
    public void sendSingleMessage(String message) {
        ...
        SQSConfig.bufferedSqs.sendMessage(sendMessageRequest);
    }
    ...
    public void sendFIFOSingleMessage(String message, String messageGroupId) {
        ...
        sendMessageRequest.setQueueUrl(SQSConfig.endpoint);
        String sendMessage = message;
        sendMessage = sendMessage + "__messageGroupId=" + messageGroupId;
    ...
    public void sendBatchMessages(String message) {
        ...
        List<SendMessageBatchRequestEntry> entryList = Stream.iterate(0, i -> i < 10, i -> i + 1)
                .map(numb -> {
        ...
        SendMessageBatchResult result = SQSConfig.bufferedSqs.sendMessageBatch(sqsBatchRequest);
